...
import com.robinhsueh.movieinfo.model.auth.RequestTokenResponse;
import com.robinhsueh.movieinfo.model.user.UserData;
import com.robinhsueh.movieinfo.utils.SharedPreferenceUtils;
import com.robinhsueh.movieinfo.viewmodel.LoginTmdbViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if (URI_MATCHER.match(url) == 100) { // movieinfo://auth?request_token=[xxx]&approved=true
