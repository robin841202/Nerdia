...
import com.robinhsueh.nerdia.model.ImagesResponse.ImageData;
import com.robinhsueh.nerdia.model.SlideShowItemData;
import com.robinhsueh.nerdia.model.StaticParameter;
import com.robinhsueh.nerdia.view.ImageDisplayActivity;
import com.robinhsueh.nerdia.view.YoutubePlayerActivity;
...
import com.robinhsueh.nerdia.model.VideosResponse;
...
public class SlideShowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public void setSlideShowItems(ArrayList<VideosResponse.VideoData> videos, ArrayList<ImageData> images, String imageSizeType) {
        ArrayList<SlideShowItemData> item_list = new ArrayList<>();
        // map videos and images data into slideshowItemData and combine
        for (VideosResponse.VideoData video : videos) {
